...
public class CglibBeanCopierUtils {
    ...
    public static <T> void copyProperties(T source, Class<T> clazz) {
        String beanKey = generateKey(source.getClass(), clazz);
        BeanCopier beanCopier = BEAN_COPIER_MAP.computeIfAbsent(beanKey, t-> BeanCopier.create(source.getClass(), clazz, false));
        beanCopier.copy(source, clazz, null);
    }
